# Guía Paso a Paso: ELMEC V2 Demo 📱

Esta guía detalla los pasos exactos y clics necesarios para operar los flujos principales del sistema según el rol del usuario.
...
3. **Formulario de Nueva Solicitud**:
   - Escribir en **"Título"** (ej: "Falla en prensa hidráulica").
...
3. **Dentro del Chat**:
   - Clic en el campo **"Escribe un mensaje..."**.
   - Escribir texto y clic en el icono de **"Enviar"** (flecha azul).
   - Clic en el icono de **"+"** (izquierda del campo de texto) para enviar fotos, archivos o notas de voz.
...
3. **Actualizar Estatus**:
   - Buscar la solicitud en la lista y **hacer clic sobre la tarjeta de la solicitud**.
   - Se abrirá el modal **"Cambiar Estado"**.
   - Clic en el nuevo estado deseado: **"En proceso"** (Verde) o **"Terminada"** (Azul).
...
4. Escribir consultas para otros agentes sin que el cliente vea estos mensajes.
...
3. **Ingresar Datos**:
   - Clic en cada campo (ej: Diámetro, Velocidad de Corte, Avance).
   - Los resultados (RPM, Velocidad de Avance) se actualizan **automáticamente** en la parte inferior de la pantalla mientras escribes.
4. Clic en **"Ajustes"** (icono de engranaje superior) para cambiar entre sistema Métrico o Imperial.
...
2. **Acciones disponibles**:
   ...
   - Clic en **"Cerrar Sesión"** (botón rojo al final) para salir de la cuenta de forma segura.
